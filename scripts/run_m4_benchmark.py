...
def setup_pod_and_benchmark():
    ...
    try:
        ...
        result = run_command(f"python3 bench/prime_gpu_bench.py --gpu-type RTX4090_24GB", check=False)
...
def main():
    ...
    parser.add_argument("--manual", action="store_true", help="Generate script only, don't auto-run")
