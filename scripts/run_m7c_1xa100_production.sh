...
echo "[ENV] NSA_USE_SEL_VARLEN=$NSA_USE_SEL_VARLEN NSA_USE_TRITON_SEL=$NSA_USE_TRITON_SEL NSA_USE_SEL_PACK=$NSA_USE_SEL_PACK NSA_USE_SEL_MASK=$NSA_USE_SEL_MASK"
