...
def test_threshold_fallback_logs(capsys):
    ...
    os.environ["NSA_SEL_TRITON_MIN_L"] = "100000"  # force threshold fallback
    os.environ["NSA_DEBUG_LOG"] = "1"
    os.environ["NSA_LOG_LIMIT"] = "4"
...
def test_dtype_fallback_logs(capsys):
    os.environ["NSA_USE_TRITON_SEL"] = "1"
    os.environ["NSA_SEL_TRITON_MIN_L"] = "0"
    os.environ["NSA_DEBUG_LOG"] = "1"
    os.environ["NSA_LOG_LIMIT"] = "4"
    device = torch.device("cuda")
    B, S, G, H, D, Dv = 1, 1, 1, 2, 64, 64
...
def test_group_path_smoke():
    os.environ["NSA_USE_TRITON_SEL"] = "1"
    os.environ["NSA_SEL_TRITON_GROUP"] = "1"
    os.environ["NSA_SEL_TRITON_MIN_L"] = "1"
    device = torch.device("cuda")
